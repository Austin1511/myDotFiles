...
let g:deoplete#sources#clang#clang_header = '/usr/local/Cellar/llvm/8.0.1/lib/clang'
...
function SetLSPShortcuts()
  ...
  nnoremap <F5> :call LanguageClient#textDocument_hover()<CR>
...
augroup LSP
  autocmd!
  autocmd FileType h,cc,cpp,c,cu call SetLSPShortcuts()
augroup END
